...
namespace RobotWebServices.OmniCoreServices.RobotWareServices
{
    public class RobotWareService
    {
        ...
        public async Task<BaseResponse<Resource7, SystemInformationState7>> GetSystemInformationAsync()
        {
            ...
            return await ControllerSession.CallAsync<BaseResponse<Resource7, SystemInformationState7>>(RequestMethod.GET, "rw/system", dataParameters, urlParameters).ConfigureAwait(false);
        ...
        public async Task<BaseResponse<IOSignalsResource, Resource7>> GetIOSignalsAsync()
        {
            ...
            var ioResp = await ControllerSession.CallAsync<BaseResponse<IOSignalsResource, Resource7>>(RequestMethod.GET, "rw/iosystem/signals", dataParameters, urlParameters).ConfigureAwait(false);
