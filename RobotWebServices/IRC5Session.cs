...
namespace RWS
{
    ...
    public class IRC5Session
    {
        ...
        public async Task<T> CallAsync<T>(RequestMethod requestMethod, string domain, Tuple<string, string>[] dataParameters, Tuple<string, string>[] urlParameters, params Tuple<string, string>[] headers)
        {
        ...
        private async Task<T> DeserializeJsonResponse<T>(HttpResponseMessage resp1)
        {
            ...
            if (IsOmniCore)
            {
                ...
                T jsonResponse7 = JsonConvert.DeserializeObject<T>(content);
                return jsonResponse7;
            }


            T jsonResponse6 = JsonConvert.DeserializeObject<T>(content);
